...
#include "tb3/srv/change_string.hpp"
#include "std_msgs/msg/string.hpp"
#include "tb3/msg/data.hpp"

// Typedefs declared by using to improve code readability

using my_data = tb3::msg::Data;
using REQUEST = std::shared_ptr
                <tb3::srv::ChangeString::Request>;
using RESPONSE = std::shared_ptr
                <tb3::srv::ChangeString::Response>;

using NODE = rclcpp::Node;

using SERVICE = tb3::srv::ChangeString;

using namespace std::chrono_literals;
using my_datatype = tb3::msg::Data;
using std::placeholders::_1;
using PUBLISHER   = rclcpp::Publisher<my_datatype>::SharedPtr;
using TIMER       = rclcpp::TimerBase::SharedPtr;
using CLIENT    = rclcpp::Client<tb3::srv::ChangeString>::SharedPtr;
...
TEST_F(CLASSNAME(test_services_client, RMW_IMPLEMENTATION), Manipulation1) {
    ...
    CLIENT client = node->create_client
                <tb3::srv::ChangeString>(service_name);
