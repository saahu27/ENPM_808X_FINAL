...
#include "tb3/srv/detail/change_string__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tb3::srv::ChangeString_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tb3::srv::ChangeString_Request & ros_message)
{
  // Member: input
  cdr >> ros_message.input;
...
{
  auto typed_message =
    static_cast<const tb3::srv::ChangeString_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tb3::srv::ChangeString_Request *>(
    untyped_ros_message);
...
{
  return &tb3::srv::typesupport_fastrtps_cpp::_ChangeString_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tb3, srv, ChangeString_Request)() {
  return &tb3::srv::typesupport_fastrtps_cpp::_ChangeString_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tb3
cdr_serialize(
  const tb3::srv::ChangeString_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: output
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tb3::srv::ChangeString_Response & ros_message)
{
  // Member: output
  cdr >> ros_message.output;
...
{
  auto typed_message =
    static_cast<const tb3::srv::ChangeString_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tb3::srv::ChangeString_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tb3::srv::typesupport_fastrtps_cpp::_ChangeString_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tb3, srv, ChangeString_Response)() {
  return &tb3::srv::typesupport_fastrtps_cpp::_ChangeString_Response__handle;
}
...
{
  return &tb3::srv::typesupport_fastrtps_cpp::_ChangeString__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tb3, srv, ChangeString)() {
  return &tb3::srv::typesupport_fastrtps_cpp::_ChangeString__handle;
}
