...
{
  new (message_memory) tb3::msg::Data(_init);
}

void Data_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tb3::msg::Data *>(message_memory);
  typed_message->~Data();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Data_message_member_array[1] = {
  {
    ...
    offsetof(tb3::msg::Data, my_data),  // bytes offset in struct
...
{
  return &::tb3::msg::rosidl_typesupport_introspection_cpp::Data_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tb3, msg, Data)() {
  return &::tb3::msg::rosidl_typesupport_introspection_cpp::Data_message_type_support_handle;
}
