...
class Metaclass_ChangeString_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tb3')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ChangeString(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tb3.srv import _change_string
...
class ChangeString(metaclass=Metaclass_ChangeString):
    from tb3.srv._change_string import ChangeString_Request as Request
    from tb3.srv._change_string import ChangeString_Response as Response
